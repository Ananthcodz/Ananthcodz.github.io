...
export default function Home() {
  ...
  const bio = {
    ...
    current: "Tata Technologies Limited",
    location: "Pune, India",
    philosophy:
  ...
  const socials = [
    { label: "Github", link: "https://github.com/Ananthcodz", icon: SiGithub },
    {
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/ananthakrishnancancode/",
      icon: SiLinkedin,
    },
    {
      label: "Gmail",
      link: "mailto:ananth2003.professional@gmail.com",
      icon: SiGmail,
    },
    {
      label: "MonkeyType",
      link: "https://monkeytype.com/profile/Ananthcodz",
      icon: SiMonkeytype,
    },
    {
      label: "Discord",
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex mt-25 justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        {/* Animated background */}
        ...
        <div className="relative z-10 text-center max-w-5xl">
          <div className="mb-8">
            <span className="text-pink-500 font-mono text-sm tracking-widest">
              &lt;code&gt;
            </span>
          </div>
          ...
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold mb-6 relative">
            <span className="relative inline-block">
              ...
              <span className="absolute inset-0 text-cyan-400 blur-xl opacity-50">
                {text}
              </span>
            </span>
          </h1>
          ...
          <div className="space-y-4 mb-12">
            <p
              className="text-xl sm:text-2xl text-gray-300 font-mono glitch-text"
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a
              href="#about"
              className="group relative px-8 py-3 bg-transparent border-2 border-cyan-500 text-cyan-400 font-mono font-bold overflow-hidden transition-all duration-300 hover:text-black"
            >
            ...
            <a
              href="#contact"
              className="group relative px-8 py-3 bg-transparent border-2 border-pink-500 text-pink-400 font-mono font-bold overflow-hidden transition-all duration-300 hover:text-black"
            >
      ...
      <section
        id="about"
        className="relative py-20 px-4 sm:px-6 lg:px-8 border-t border-cyan-500/30"
      >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-2 text-gray-300 font-mono text-sm pl-4">
                    <p>
                      ...
                      <span className="text-green-400">{bio.name}</span>,
                    </p>
                    <p>
                      <span className="text-pink-400">role:</span>{" "}
                      <span className="text-green-400">{bio.role}</span>,
                    </p>
                    <p>
                      <span className="text-pink-400">passion:</span>{" "}
                      <span className="text-green-400">{bio.passion}</span>,
                    </p>
                    <p>
                      <span className="text-pink-400">
                        Current Organization:
                      </span>{" "}
                      <span className="text-green-400">{bio.current}</span>
                    </p>
                    <p>
                      <span className="text-pink-400">location:</span>{" "}
                      <span className="text-green-400">{bio.location}</span>
                    </p>
                  </div>
                  <h3 className="text-2xl font-bold text-cyan-400 mt-3 font-mono">
                    {"}"}
                  </h3>
                </div>
              ...
              <div className="p-6 bg-black/50 border border-pink-500/30 backdrop-blur-sm">
                <p className="text-gray-300 leading-relaxed">
                  Am a passionate developer who loves turning complex problems
                  into elegant solutions. With a keen eye for design and a deep
                  understanding of modern technologies, I create experiences
            ...
            <div className="space-y-6">
              <div className="p-6 bg-gradient-to-br from-pink-500/5 to-cyan-500/5 border border-pink-500/30 hover:border-pink-400 transition-all duration-300">
                ...
                <ul className="space-y-3 text-gray-300">
                  {[
                    ...
                    "Mastering the world of microservices",
                    "Mastering System Design Solutions",
                    ...
                    >
                      <span className="text-cyan-400 mt-1 group-hover:text-pink-400 transition-colors">
                        ▹
                      </span>
              ...
              <div className="relative p-6 bg-black/50 border border-cyan-500/30 overflow-hidden group">
                ...
                <h3 className="text-xl font-bold text-cyan-400 mb-4 font-mono relative z-10">
                  🎯 PHILOSOPHY
                </h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                category: "Frontend",
                skills: ["React", "Next.js", "AngularJS", "TypeScript"],
                color: "cyan",
              },
              {
                category: "Backend",
                skills: ["NestJS", "Node.js", "SpringBoot", "Django"],
                color: "pink",
              },
              {
                category: "Database",
              ...
              {
                category: "Tools",
                skills: ["Postman", "Linux/Ubuntu", "Agile", "OpenCV"],
                color: "yellow",
              },
              {
                category: "Learning..",
                skills: ["AI/ML", "Rust", "Blockchain", "Cloud Infrastructure"],
                color: "orange",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="group relative p-6 bg-black/50 border border-gray-700 hover:border-cyan-400 transition-all duration-300 overflow-hidden"
              >
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="p-8 bg-gradient-to-br from-cyan-500/5 to-pink-500/5 border border-cyan-500/30 mb-8">
            ...
            <div className="group inline-block relative px-10 py-4 bg-transparent border-2 border-cyan-500 text-cyan-400 font-mono font-bold text-lg overflow-hidden transition-all duration-300 hover:text-black">
              <Link href="/contact">
          ...
          <div className="flex justify-center gap-6">
            {socials.map(({ label, link, icon }) => (
              <a
                ...
                className="flex gap-4 justify-center align-center text-center group relative p-4 bg-black border border-gray-700 hover:border-cyan-400 transition-all duration-300"
              >
                ...
                <span className="text-gray-400 group-hover:text-cyan-400 font-mono text-sm transition-colors duration-300">
                  {label}
                </span>
